...
HTMX + TailwindCSS based web application
"""
...
def complete_task():
    ...
    evolved = False
    if creature:
        # 進化ロジックは creature_system 内で処理済み
        pass
...
def create_playlist():
    ...
    if name:
        playlist = Playlist(name=name, description="")
...
def creature():
    ...
    if current_creature:
        ...
        image_filename = creature_system.get_image_filename(current_creature)
